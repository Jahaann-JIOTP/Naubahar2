                  ...
                  <div class="page-body">
                    ...
                    <div class="card" style=" border: 1px solid #9f9fa3; border-radius: 5px;background-color: #fbfbfb;margin: 5px 5px 5px 0px;border-top: 5px solid #7699d4;">
                      <div class="card-header" style="height:50px; padding: 0.5rem 1rem">
                        <h4 style="padding-top:9px" class="card-title"> Energy Cost Report</h4>
                      </div>
                      <div class="card-block">
                        <form class="form-horizontal" action="energy_report.php" method="POST">
                          <div class="form-group row" style="margin-top: 20px;">
                            <label class="col-sm-1 col-form-label">Title</label>
                            <div class="col-sm-3">
                              <input type="text" class="form-control" aria-describedby="emailHelp" name="title" value="Energy Cost">
                              <!-- <small class="form-hint">Report Title as per your format.</small> -->
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            <label class="col-sm-1 col-form-label">Rates</label>
                            <div class="col-md-3 col-xs-11">
                              <input class="form-control form-control-inline input-medium default-date-picker" type="number" placeholder="0.00" name="unit" step="any" autocomplete="off" required>
                              <small class="form-hint" style="color: black">
                                Enter per Unit Cost in the above Field.
                              </small>
                            </div>
                          </div><br>
                          <div class="form-group row">
