                      ...
                      <div class="col-lg-12 row">
                        <div class="col-lg-6">
                          <div class="text-capitalize">
                            <br>
                            <button class="btn" id="exportButton" style="background-color:#d64d3d;color:white">EXPORT</button>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="text-capitalize" style="text-align: right;">
                            <br>
                            <button class="btn" onclick="history.back()" style="margin-left:3px;background-image: linear-gradient(#16569a, #406e9f, #6794c5, #add8f0);color:white">Back to log</button>
                          </div>
                        </div>
                      </div>
                      <div class="no-gutters box" style="overflow-x: scroll;width: 100%;min-height: 600px;padding-top: 20px;">
                        <table class="table table-striped table-advance table-hover" id="headerTable">
                          ...
                          <?php } elseif ($val == 'current') { ?>
                            <th style="text-align:center;">Time</th>
                            <th style="text-align:center;">Current A</th>
                            <th style="text-align:center;">Current B</th>
                            <th style="text-align:center;">Current C</th>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> -->
    <script type="text/javascript">
      function volt_display() {
        ...
        $.ajax({
          url: "show_log.php?s=" + str + "&e=" + str2 + "&meter=<?php echo $meter; ?>&val=<?php echo $val; ?>",
