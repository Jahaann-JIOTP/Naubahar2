...
// SQL query
$sql = mysqli_query($conn, "SELECT * FROM terif2 WHERE August='$date'");
$row = mysqli_fetch_array($sql);
$sql1 = mysqli_query($conn, "SELECT * FROM production2 WHERE id='1'");
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card" style="border-radius: 10px !important;">
                                            <div class="card-header" style="border-top:5px solid;border-color:#7699d4;height:50px; padding: 0.5rem 1rem;border-bottom: 1px solid #9f9fa3;border-left: 1px solid #9f9fa3;border-right:1px solid #9f9fa3;border-radius: 6px ">
                                                ...
                                                $conn = new mysqli($servername, $username, $password, $database);
                                                $sql = mysqli_query($conn, "SELECT * FROM terif2");
                                                $row = mysqli_fetch_array($sql);
                                                ?>
                                            </div>
                                        </div><br>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-12" style="margin-left:10px;height:50px">
                                                                        <p style="font-size: 16px !important;">
                                                                            <b><?php echo date('m/d/Y 12:00:00', strtotime($start_date)); ?>
                                                                                AM -
                                                                                <?php echo date('m/d/Y 12:00:00', strtotime($end_date)); ?>
                                                                        ...
                                                                        <h4 style="color: #0047AB;">Naubahar</span>
                                                                            ...
                                                                            Company<small class="float-right">
                                                                                <div style="margin-right:20px;color:black ">
                                                                                    Energy Production Report Unit 2</div>
                                                                            </small></h4>
                                                ...
                                                <div class="card-block">
                                                    <div class="row invoice-info">
                                                        ...
                                                        <div class="col-md-4 col-sm-8 offset-md-1 invoice-col" style=" background-color:#f4f4f4; border-left: 3px solid #1348A8;">
                                                            To
                                                            <address>
                                                                <strong>Naubahar Unit 2</strong><br>
                                                                ...
                                                                foreach ($docs as $document) {
                                                                    ...
                                                                    foreach ($document as $key => $value) {
                                                                        ...
                                                                        if (!empty($document['GW1_U26_ActiveEnergy_Delivered_kWh'])) {
                                                                            $arr2[] = $document['GW1_U26_ActiveEnergy_Delivered_kWh'];
                                                                        }
    ...
    <script type="text/javascript">
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) // If Internet Explorer
            {
                ...
                txtArea1.focus();
                sa = txtArea1.document.execCommand("SaveAs", true, "Production_Report_Unit2.xls");
                ...
                try {
                    ...
                    if (document.getElementById("caption") != null) {
                        ...
                        a.download = 'Production_Report_Unit2';
                    }
