                                                            ...
                                                            <thead>
                                                                <tr style="background-color:#ebecec ; border-bottom: 3px solid #1348A8;">
                                                                    ...
                                                                    foreach ($_POST['checkbox'] as $sources) {
                                                                        if ($sources == "U_1") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Main LT';
                                                                        }
                                                                        elseif ($sources == "U_2") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Water Treatment';
                                                                        }
                                                                        elseif ($sources == "U_3") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Turbine 1';
                                                                        }
                                                                        elseif ($sources == "U_4") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Syrup Room';
                                                                        }
                                                                        elseif ($sources == "U_5") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Air Compressor(3+4+5)';
                                                                        }
                                                                        elseif ($sources == "U_6") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Air Compressor(1+2)';
                                                                        }
                                                                        elseif ($sources == "U_7") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Grasso 4';
                                                                        } elseif ($sources == "U_8") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Grasso 3';
                                                                        }
                                                                        elseif ($sources == "U_9") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Grasso 2';
                                                                        }
                                                                        elseif ($sources == "U_10") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Grasso 1';
                                                                        }
                                                                        elseif ($sources == "U_11") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Evaporators';
                                                                        }
                                                                        elseif ($sources == "U_12") {
                                                                            $area_name = 'LT Panel Room';
                                                                            $sources_name = 'Line-5';
