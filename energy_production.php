                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card" style=" border: 1px solid #9f9fa3; border-radius: 5px;background-color: #fbfbfb;margin: 5px 5px 5px 0px;border-top: 5px solid #7699d4;">
                                            <div class="card-header" style="height:70px; padding: 0.5rem 1rem;border-bottom: 1px solid #e7eaed;">
                                                <h4 style="padding-top:3px"> Energy Production Report
                                                    <a href="add-prduction.php" class="btn" style="color:white ; width:175px; border-radius:30px; float:right;background-color:#3e8fc6"><span class=""></span>Add Production</a>
                                                    <a href="#edit" data-toggle="modal" class="btn" style="color:white ; width:150px; border-radius:30px; float:right;background-color:#d64d3d"><span class=""></span>Add Triff</a>
                                                    <?php include('Model2.php'); ?>
                                                </h4>
                                            </div>
                                            <div class="card-block">
                                                <form action="energy_production_report.php" method="POST">
                                                    <div class="form-group row" style="margin-top: 20px;">
                                                        <label class="col-sm-2 col-form-label">Title</label>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" aria-describedby="emailHelp" name="title" value="Energy Production Report">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <select onchange="displayDivDemo('hideValuesOnSelect', this); displayDivDemo1('hideValuesOnSelect1', this); displayDivDemo2('hideValuesOnSelect2', this)" class="form-select custom-select" required name="option" style="width:74%">
                                                    ...
                                                    <div id="hideValuesOnSelect">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input id="start" type="date" name="start_date" class="form-control " placeholder="Select a date" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">End Date</label>
                                                            <div class="col-sm-3">
                                                                <input id="end" type="date" name="end_date" class="form-control " placeholder="Select a date" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="hideValuesOnSelect1">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input id="calendar-simple" type="month" name="month_date" class="form-control " placeholder="Select a Month">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="hideValuesOnSelect2">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input id="calendar-simple" type="week" name="week_date" class="form-control " placeholder="Select a Week" />
                                                            </div>
                                                        </div>
