                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h4 class="m-b-10">LPAC Section</h4>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!" style="color: #284497">LPAC
                                                    Section</a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class=" card items"
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class=""
                                                    ...
                                                    <div class="card-body" style="height: 185px;">
                                                        <div class="d-flex">
                                                            <h5 class="card-title" style="color: black"><b>GA90-VSD(Old)</b>
                                                            </h5>
                                                            <div class="ml-auto">
                                                                <div class="dropdown">
                                                                    <select id="total_energy_option_lp1"
                                                        ...
                                                        <center>
                                                            <div>
                                                                <b><span style="padding-left: 1%;font-size: 34px;color: black "
                                                                        id="total_energy_value_lp1"></span></b><span
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class=""
                                                    ...
                                                    <div class="card-body" style="height: 185px;">
                                                        <div class="d-flex">
                                                            <h5 class="card-title" style="color: black"><b>GA90-Old</b>
                                                            </h5>
                                                            <div class="ml-auto">
                                                                <div class="dropdown">
                                                                    <select id="total_energy_option_lp2"
                                                                        class="form-select" required name="option"
                                                                        onchange="lp_2()">
                                                                        <option value="Today">Today</option>
                                                                        <option value="Yesterday">Yesterday</option>
                                                        ...
                                                        <center>
                                                            <div>
                                                                <b><span style="padding-left: 1%;font-size: 34px;color: black "
                                                                        id="total_energy_value_lp2"></span></b><span
                                                                    style="color: black">&nbsp&nbspkWh</span>
                                                            </div>
                                                        </center>
                                                    </div>
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class=""
                                                    ...
                                                    <div class="card-body" style="height: 185px;">
                                                        <div class="d-flex">
                                                            <h5 class="card-title" style="color: black"><b>GA90-VSD(New)</b>
                                                            </h5>
                                                            <div class="ml-auto">
                                                                <div class="dropdown">
                                                                    <select id="total_energy_option_lp3"
                                                                        class="form-select" required name="option"
                                                                        onchange="lp_3()">
                                                                        <option value="Today">Today</option>
                                                                        <option value="Yesterday">Yesterday</option>
                                                        ...
                                                        <center>
                                                            <div>
                                                                <b><span style="padding-left: 1%;font-size: 34px;color: black "
                                                                        id="total_energy_value_lp3"></span></b><span
                                                                    style="color: black">&nbsp&nbspkWh</span>
                                                            </div>
                                                        </center>
                                                    </div>
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div class="" style="background:none; margin-top:10px">
                                                    <div class="card-body" style="height: 185px;">
                                                        <div class="d-flex">
                                                            <h5 class="card-title" style="color: black"><b>GA90-New</b>
                                                            </h5>
                                                            <div class="ml-auto">
                                                                <div class="dropdown">
                                                                    <select id="total_energy_option_lp4"
                                                                        class="form-select" required name="option"
                                                                        onchange="lp_4()">
                                                                        <option value="Today">Today</option>
                                                                        <option value="Yesterday">Yesterday</option>
                                                        ...
                                                        <center>
                                                            <div>
                                                                <b><span style="padding-left: 1%;font-size: 34px;color: black "
                                                                        id="total_energy_value_lp4"></span></b><span
                                                                    style="color: black">&nbsp&nbspkWh</span>
                                                            </div>
                                                        </center>
                                                    </div>
                                                ...
                                                <div class="card"
                                                    ...
                                                    <div class="card-body"
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ml-auto">
                                                                <div class="dropdown">
                                                                    <select id="total_energy_option_S5"
                                                                        class="form-select" required
                                                                        name="option"
                                                                        onchange="LPACSecEnergy()">
                                                        ...
                                                        <center>
                                                             <img src="assets/images/LP_comp.png" alt=""
                                                                    height="auto" width="65%">
                                                            <div>
                                                              <b><span style="padding-left: 1%;font-size: 34px; " id="total_energy_value_S5"></span></b><span >&nbsp&nbspkWh</span>  
                                                            </div>
                                                        </center>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card"
                                                    ...
                                                    <div class="card-body"
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ml-auto">
                                                                <div class="dropdown">
                                                                    <select id="energy_cost_pie_option4" class="form-select"
                                                                        required name="option"
                                                                        onchange="energy_pie4(this.options[this.selectedIndex].value)">
                                                                        <option value="Today">Today</option>
                                                                        <option value="Last 7 Days">Last 7 Days</option>
                                                       ...
                                                       <div id="energy_cost_pie_chart4" style="width: 100%;height:95%"></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card"
                                                    ...
                                                    <div class="card-body"
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ml-auto">
                                                                <div class="dropdown">
                                                                    <select id="energy_option_LPAC" class="form-select"
                                                                        required name="option" onchange="energy_LPAC(this.options[this.selectedIndex].value);">
                                                                        <option value="Last 7 Days">Last 7 Days</option>
                                                                        <option value="Last 30 Days">Last 30 Days
                                                                        </option>
                                                                        <option value="Last Week">Last Week</option>
                                        ...
                                        <div class="col-lg-12 col-xl-12 col-sm-12">
                                                <div class="card"
                                                    style="border-radius: 10px !important;background-color:#e6eaf3;">
                                                    <div class="card-body"
                                                        style="height: 450px;border-top-style: solid;border-radius: 10px !important;border-color: #206bc4;">
                                                        <div class="d-flex">
                                                                    ...
                                                                    <table class="table table-hover">
                                                                        ...
                                                                        <tbody style="overflow: scroll;height: 100px">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo round($GW2_U12_Current_Avg_Amp/10,2); ?>
                                                                                    (A)</td>
                                                                                <td><?php echo round($GW2_U12_Voltage_LL_V/10,2); ?>
                                                                                    (V)</td>
                                                                                <td><?php echo round($GW2_U12_ActivePower_Total_kW,2); ?>
                                                                                    (kW)</td>
                                                                                <?php if($GW2_U12_Current_Avg_Amp==0 && $GW2_U12_Voltage_LL_V==0 && $GW2_U12_ActivePower_Total_kW==0 ) { ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo round($GW2_U11_Current_Avg_Amp/10,2); ?>(A)
                                                                                </td>
                                                                                <td><?php echo round($GW2_U11_Voltage_LL_V/10,2); ?>(V)
                                                                                </td>
                                                                                <td><?php echo round($GW2_U11_ActivePower_Total_kW,2); ?>
                                                                                    (kW)</td>
                                                                                <?php if($GW2_U11_Current_Avg_Amp==0 && $GW2_U11_Voltage_LL_V==0 && $GW2_U11_ActivePower_Total_kW==0 ) { ?>
                                                                                <td><img src="assets/images/red_bl.gif"
                                                                                        style="height: 23px; width: 23px;">
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo round($GW2_U14_Current_Avg_Amp/10,2); ?>
                                                                                    (A)</td>
                                                                                <td><?php echo round($GW2_U14_Voltage_LL_V/10,2); ?>
                                                                                    (V)</td>
                                                                                <td><?php echo round($GW2_U14_ActivePower_Total_kW,2); ?>
                                                                                    (kW)</td>
                                                                                <?php if($GW2_U14_Current_Avg_Amp==0 && $GW2_U14_Voltage_LL_V==0 && $GW2_U14_ActivePower_Total_kW==0 ) { ?>
                                                                                <td><img src="assets/images/red_bl.gif"
                                                                                        style="height: 23px; width: 23px;">
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo round($GW2_U13_Current_Avg_Amp/10,2); ?>
                                                                                    (A)</td>
                                                                                <td><?php echo round($GW2_U13_Voltage_LL_V/10,2); ?>
                                                                                    (V)</td>
                                                                                <td><?php echo round($GW2_U13_ActivePower_Total_kW,2); ?>
                                                                                    (kW)</td>
                                                                                <?php if($GW2_U13_Current_Avg_Amp==0 && $GW2_U13_Voltage_LL_V==0 && $GW2_U13_ActivePower_Total_kW==0 ) { ?>
                                                                                <td><img src="assets/images/red_bl.gif"
                                                                                        style="height: 23px; width: 23px;">
                                                                                </td>
...
<script> 
  ...
  $("#load").load(window.location.href + " #load" );
    ...
    function lp_1()
    {
        var str=document.getElementById("total_energy_option_lp1").value;
        var jsonData = $.ajax({
        url: "calculations/LPACSecEnergy/LPAC-1.php?value="+str,
        dataType: "json",
        async: false,
        }).responseText;
        $("#total_energy_value_lp1").html(jsonData);
    }
     lp_1('Today'); 
     function lp_2()
    {
        var str=document.getElementById("total_energy_option_lp2").value;
        var jsonData = $.ajax({
        url: "calculations/LPACSecEnergy/LPAC-2.php?value="+str,
        dataType: "json",
        async: false,
        }).responseText;
        $("#total_energy_value_lp2").html(jsonData);
    }
     lp_2('Today'); 
     function lp_3()
    {
        var str=document.getElementById("total_energy_option_lp3").value;
        var jsonData = $.ajax({
        url: "calculations/LPACSecEnergy/LPAC-3.php?value="+str,
        dataType: "json",
        async: false,
        }).responseText;
        $("#total_energy_value_lp3").html(jsonData);
    }
     lp_3('Today'); 
     function lp_4()
    {
        var str=document.getElementById("total_energy_option_lp4").value;
        var jsonData = $.ajax({
        url: "calculations/LPACSecEnergy/LPAC-4.php?value="+str,
        dataType: "json",
        async: false,
        }).responseText;
        $("#total_energy_value_lp4").html(jsonData);
    }
     lp_4('Today'); 
    function LPACSecEnergy()
    {
        var str=document.getElementById("total_energy_option_S5").value;
        var jsonData = $.ajax({
        url: "calculations/unit2/LPACSecEnergy.php?value="+str,
        dataType: "json",
        async: false,
        }).responseText;
        $("#total_energy_value_S5").html(jsonData);
    }
    LPACSecEnergy('Today');
    energy_pie4("Today");
    function energy_pie4(str2) {
        am4core.ready(function() {
            am4core.useTheme(am4themes_animated);
            var chart = am4core.create("energy_cost_pie_chart4", am4charts.PieChart3D);
            if (chart.logo) {
            ...
            chart.dataSource.url = "calculations/unit2Piechart/LPACSecPiechart.php?value=" + str2;
        ...
        series.labels.template.adapter.add("fill", function(color, target) {
            ...
            series.colors.list = [
                ...
                am4core.color("#bd2d18"), // Lp 1
                am4core.color("#f39402"), // Lp 2
                am4core.color("#313131"), // Lp 3
                am4core.color("#808000"), // Lp 4
            ];
            // Responsive
            ...
            chart.exporting.filePrefix = 'LPAC Energy Consumption Breakdown';
    ...
    //LPAC bar
 function energy_LPAC(str2){
  am4core.ready(function() {
  am4core.useTheme(am4themes_animated);
  var chart = am4core.create('energy_chart_LPAC', am4charts.XYChart)
 if(chart.logo) {
    chart.logo.disabled = true ;
  }
chart.legend = new am4charts.Legend();
...
chart.dataSource.url = "calculations/unit2barchart/LPACSec.php?value="+str2;
//calculations/database4.php
// createSeries('value1', 'Main LT');
createSeries('LPAC_1', 'GA90-VSD(Old)');
createSeries('LPAC_2', 'GA90-Old');
createSeries('LPAC_3', 'GA90-VSD(New)');
createSeries('LPAC_4', 'GA90-New');
...
chart.exporting.menu.align = "right";
chart.exporting.menu.verticalAlign = "top";
chart.exporting.filePrefix = 'LPAC Energy Usage';
chart.exporting.formatOptions.getKey("json").disabled = true;
chart.exporting.formatOptions.getKey("html").disabled = true;
chart.exporting.formatOptions.getKey("csv").disabled = true;
chart.exporting.formatOptions.getKey("pdf").disabled = true;
