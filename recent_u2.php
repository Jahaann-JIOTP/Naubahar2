              ...
              <div>
                ...
                $sql = "
                    SELECT 
                        ...
                        e.end,
                        CONCAT(
                            FLOOR(MOD(TIMESTAMPDIFF(SECOND, e.start, e.end), 216000) / 3600), ' hours ',
                            FLOOR(MOD(TIMESTAMPDIFF(SECOND, e.start, e.end), 3600) / 60), ' Minutes ',
                            MOD(TIMESTAMPDIFF(SECOND, e.start, e.end), 60), ' Seconds '
                        ) as Duration
                    FROM test_unit2 t
                    JOIN (
                        SELECT 
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h3 id="myModalLabel">Alarms Naubahar Unit 2</h3>
