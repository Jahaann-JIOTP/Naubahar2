                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h4 class="m-b-10">Energy Cost Report (Unit 2)</h4>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!" style="color: #284497">Energy Cost
                                                    Report (Unit 2)</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="card" style=" border: 1px solid #9f9fa3; border-radius: 5px;background-color: #fbfbfb;margin: 5px 5px 5px 0px;border-top: 5px solid #7699d4;">
                                            ...
                                            <div class="card-body">
                                                <form action="energy_cost_report_unit2.php" method="post">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="number" class="form-control" placeholder="0.00" name="unit" step="any" autocomplete="off" required>
