    ...
    <div class="pcoded-inner-navbar main-menu">
        <div class="">
            <div class="main-menu-header" style="height: 120px">
                <img class="img-80 img-radius" src="<?php echo $avatar; ?>" alt="User-Profile-Image"
                    style="margin-top:3px">
                <div class="user-details">
                    <span id="more-details"><?php echo $row['name']; ?><i class="fa fa-caret-down"></i></span>
                </div>
            </div>
        ...
        <div class="sidebar-wrapper">
          ...
          <form class="form-material">
            ...
            <div class="pcoded-navigation-label" data-i18n="nav.category.navigation" style="color: #1434A4">Dasboards
            </div>
            <ul class="pcoded-item">

                <li
                    class="pcoded-hasmenu <?php if($page =='home.php' || $page == 'cost_comparison_u1.php' || $page == 'status_table_u1.php' ){echo 'pcoded-trigger ';}  ?>">
                    <a href="#"
                        class="waves-effect waves-dark  <?php if($page =='home.php' || $page == 'cost_comparison_u1.php' || $page == 'status_table_u1.php' ){echo 'active';}?>">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class=" <?php if($page =='home.php'){echo 'active';}?>">
                            <a href="home.php" class="waves-effect waves-dark">
                                ...
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Plant Summary</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='cost_comparison_u1.php'){echo 'active';}?>">
                            <a href="cost_comparison_u1.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-dollar fa-lg" style="color: red"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Cost Comparison</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='status_table_u1.php'){echo 'active';}?>">
                            <a href="status_table_u1.php" class="waves-effect waves-dark">
                                ...
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Status Table</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                    </ul>
                ...
                <li
                    class="nav-item pcoded-hasmenu  <?php if($page =='home1.php' || $page == 'cost_comparison.php' || $page == 'T2_energy.php' || $page == 'T3_energy.php' || $page == 'T4_energy.php' ||  $page == 'T5_energy.php' ||  $page == 'T6_energy.php' ){echo 'pcoded-trigger ';}  ?>">
                    <a href="#"
                        class="waves-effect waves-dark nav-link <?php if($page =='home1.php' || $page == 'cost_comparison.php' || $page == 'T2_energy.php' || $page == 'T3_energy.php' ){echo 'active';}?>">
                        <span class="pcoded-micon"><i class="fa fa-dashboard fa-lg"></i><b></b></span>
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="<?php if($page =='home1.php'){echo 'active';}?>">
                            <a href="home1.php" class="waves-effect waves-dark">
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Plant Summary</span>
                            </a>
                        </li>
                        <li class="<?php if($page =='T3_energy.php'){echo 'active';}?>">
                            <a href="T3_energy.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-dollar fa-lg" style="color: red"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">RO Section</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='T2_energy.php'){echo 'active';}?>">
                            <a href="T2_energy.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-dollar fa-lg" style="color: red"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Grasso Section</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='cost_comparison.php'){echo 'active';}?>">
                            <a href="cost_comparison.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-dollar fa-lg" style="color: red"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">ECR Section</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='T4_energy.php'){echo 'active';}?>">
                            <a href="T4_energy.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-dollar fa-lg" style="color: red"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Line Section</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='T5_energy.php'){echo 'active';}?>">
                            <a href="T5_energy.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-dollar fa-lg" style="color: red"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">LPAC Section</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='T6_energy.php'){echo 'active';}?>">
                            <a href="T6_energy.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-dollar fa-lg" style="color: red"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">HPAC Section</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li
                    class="<?php if($page =='oneline.php'|| $page == 'diagram.php' || $page == 'meter_diagram.php' || $page == 'log_unit2.php' || $page == 'log_detailunit2.php' ){echo 'active';}?>">
                    <a href="oneline.php" class="waves-effect waves-dark">
                        <span class="pcoded-micon"><i class="fa fa-sitemap fa-lg"
                                style="color: white"></i><b>FC</b></span>
                        <span class="pcoded-mtext" data-i18n="nav.form-components.main" style="color: white">Unit
                            2</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                </li>
            </ul>
            <div class="pcoded-navigation-label" data-i18n="nav.category.forms" style="color:#1434A4">Trends</div>
            <ul class="pcoded-item pcoded-left-item">
                <li class="<?php if($page =='customize_trends.php'){echo 'active';}?>">
                    <a href="customize_trends.php" class="waves-effect waves-dark">
                        <span class="pcoded-micon"> <i class="fa fa-line-chart fa-lg"
                                style="color: white"></i><b>FC</b></span>
            ...
            <div class="pcoded-navigation-label" data-i18n="nav.category.other" style="color: #1434A4">Reports</div>
            <ul class="pcoded-item pcoded-left-item">
                <li
                    class="nav-item pcoded-hasmenu  <?php if($page =='energy_cost.php' || $page == 'energy_usage.php' || $page == 'energy_usage_report.php' || $page =='energy_production.php' || $page =='energy_production_report.php' || $page =='add-prduction.php'){echo 'pcoded-trigger ';}  ?>">
                    <a href="#"
                        class="waves-effect waves-dark nav-link <?php if($page =='energy_cost.php' || $page == 'energy_usage.php' || $page == 'energy_usage_report.php' || $page =='energy_production.php' || $page =='energy_production_report.php'|| $page =='add-prduction.php' ){echo 'active';}?>">
                    ...
                    <ul class="pcoded-submenu">
                        <li
                            class="<?php if($page =='energy_cost.php' || $page =='energy_report.php' ){echo 'active';}?>">
                            <a href="energy_cost.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-file fa-lg"
                                        style="color: white"></i><b>M</b></span>
                        ...
                        <li
                            class="<?php if($page =='energy_usage.php' || $page =='energy_usage_report.php'){echo 'active';}?>">
                        ...
                        <li
                            class="<?php if($page =='energy_production.php' || $page =='energy_production_report.php'){echo 'active';}?>">
                            <a href="energy_production.php" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="fa fa-file fa-lg"
                                        style="color: white"></i><b>M</b></span>
                                <span class="pcoded-mtext" data-i18n="nav.menu-levels.main"
                                    style="color: black">Customized
                                    Report</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='add-prduction.php'){echo 'active';}?>">
                ...
                <li
                    class="nav-item pcoded-hasmenu  <?php if($page =='energy_usage2.php' || $page == 'energy_cost2.php' || $page == 'energy_usage_report2.php' || $page == 'energy_cost_report2.php'){echo 'pcoded-trigger ';}  ?>">
                    <a href="#"
                        class="waves-effect waves-dark nav-link <?php if($page =='energy_usage2.php' || $page == 'energy_cost2.php' || $page == 'energy_usage_report2.php' || $page == 'energy_cost_report2.php'){echo 'active';}?>">
                        <span class="pcoded-micon"><i class="fa fa-file fa-lg" style="color: white"></i><b></b></span>
                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Unit 2</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                    <ul class="pcoded-submenu">
                        <li class="<?php if($page =='energy_cost2.php' || $page == 'energy_cost_report2.php'){echo 'active';}?>">
                            <a href="energy_cost2.php" class="waves-effect waves-dark">
                                
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Energy Cost Report</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="<?php if($page =='energy_usage2.php' || $page == 'energy_usage_report2.php'){echo 'active';}?>">
                            <a href="energy_usage2.php" class="waves-effect waves-dark">
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.main"
                                    style="color: black">Energy Usage Report</span>
                            </a>
                        </li>
                    </ul>
                </li>
            </ul>
            <div class="pcoded-navigation-label" data-i18n="nav.category.other" style="color: #1434A4">User Managment
            </div>
            <ul class="pcoded-item pcoded-left-item">
                <li class="<?php if($page =='user.php'){echo 'active';}?>">
                    <a href="user.php" class="waves-effect waves-dark">
                        <span class="pcoded-micon"><i class="fa fa-user fa-lg" aria-hidden="true"
                                style="color: white"></i><b>M</b></span>
                        <span class="pcoded-mtext" data-i18n="nav.menu-levels.main" style="color: white">Add User</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                </li>
                <li class="<?php if($page =='view_user.php' || $page =='edit.php'){echo 'active';}?>">
