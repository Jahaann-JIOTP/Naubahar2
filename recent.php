                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-4">
                    <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="#!" style="color: #284497"> Recent Alarms</a>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                FROM (
                    SELECT 
                        ...
                        CONCAT(
                            FLOOR(
                                MOD(
                                    TIMESTAMPDIFF(SECOND, t2.start, t2.end), 216000
                                ) / 3600
                            ), ' hours ',
                            FLOOR(
                                MOD(
                                    TIMESTAMPDIFF(SECOND, t2.start, t2.end), 3600
                                ) / 60
                            ), ' Minutes ',
                            MOD(
                                TIMESTAMPDIFF(SECOND, t2.start, t2.end), 60
                            ), ' Seconds '
                        ) AS Duration
                    FROM test t1
                    INNER JOIN (
                        SELECT 
                            ...
                            MIN(Time) AS start 
                        FROM test
                        GROUP BY Source, Status -- Changed from GROUP BY Event to GROUP BY Source, Status
                    ) t2 
