...
if (count($_POST) > 0) {
    $sql = mysqli_query($con, "ALTER TABLE production ADD `$col` BLOB");
}
if (count($_POST) > 0) {
    $sql2 = mysqli_query($con, "UPDATE production set `$col` = '" . $_POST['val'] . "'");
}
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h4 class="m-b-10">Add Daily Production</h4>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <form class="text-center my-wrap pt-5 pb-5" method="POST" action="">
                                            <h1 class="h3 mb-3 font-weight-bold text-uppercase" style="color: var(--e_blue)">Add Daily Production</h1>
                                        ...
                                        <div class="card">
                                            <div class="card-header" style="height:65px;color:rgb(34, 33, 33); border-top-style: solid;border-radius: 10px !important;border-color: #206bc4;background-color:#7ea5c5">
                                                <h4>History Of Daily Production</h4>
                                            </div>
                                            <div class="" style="overflow: auto;">
                                                <?php
                                                //get results from database
                                                $result1 = mysqli_query($con, "SELECT * FROM production");
                                                // var_dump($result);
