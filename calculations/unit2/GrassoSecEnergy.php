...
function fetchData($start_date,$end_date){
    ...
    $where = array(
     ...
     $select_fields = array(
         ...
         'GW1_U14_ActiveEnergy_Delivered_kWh' => 1,
         'PLC_Date_Time' => 1,
     );
     $options = array(
     ...
     foreach ($docs as $document) {
         ...
         foreach ($document as $key => $value) {
              ...
              $arr[] = $document['GW1_U19_ActiveEnergy_Delivered_kWh'];
             }
             if(!empty($document['GW1_U18_ActiveEnergy_Delivered_kWh'])){
              $arr1[] = $document['GW1_U18_ActiveEnergy_Delivered_kWh'];
             }
             if(!empty($document['GW1_U17_ActiveEnergy_Delivered_kWh'])){
              $arr2[] = $document['GW1_U17_ActiveEnergy_Delivered_kWh'];
             } 
             if(!empty($document['GW1_U16_ActiveEnergy_Delivered_kWh'])){
              $arr3[] = $document['GW1_U16_ActiveEnergy_Delivered_kWh'];
             } 
             if(!empty($document['GW1_U15_ActiveEnergy_Delivered_kWh'])){
              $arr4[] = $document['GW1_U15_ActiveEnergy_Delivered_kWh'];
             } 
             if(!empty($document['GW1_U20_ActiveEnergy_Delivered_kWh'])){
              $arr5[] = $document['GW1_U20_ActiveEnergy_Delivered_kWh'];
             } 
             if(!empty($document['GW1_U21_ActiveEnergy_Delivered_kWh'])){
              $arr6[] = $document['GW1_U21_ActiveEnergy_Delivered_kWh'];
             }
             if(!empty($document['GW1_U14_ActiveEnergy_Delivered_kWh'])){
              $arr7[] = $document['GW1_U14_ActiveEnergy_Delivered_kWh'];
             } 
     ...
     $data = $U_1+$U_2+$U_3+$U_4+$U_5+$U_6+$U_7+$U_8;
