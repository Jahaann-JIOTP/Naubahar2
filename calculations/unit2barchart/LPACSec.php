...
function fetchWeekly($monthStart,$monthEnd, $tag_values,$numberOfMeters){
  ...
  $cursor = $collection->aggregate([
    ['$project' => ['UNIXtimestamp' => 1, $tag_values[0] => 1,$tag_values[1] => 1,$tag_values[2] => 1,$tag_values[3] => 1,$tag_values[4] => 1,$tag_values[5] => 1,$tag_values[6] => 1,$tag_values[7] => 1]],
    ...
    ['$project' => [
      ...
      'u6'=>'$'.$tag_values[5],'u7'=>'$'.$tag_values[6],'u8'=>'$'.$tag_values[7],
       ]],
    ['$project' => [
        'UNIXtimestamp'=>1,
  ...
  ['$project' => [
    ...
    'kWh7'=>['$subtract'=>['$lastRead8.u8','$firstRead8.u8']],
]],
  ]);
  $docs = $cursor->toArray();
  $index = 0;
...
function fetchHourly($date, $tag_values,$numberOfMeters){
  ...
  $cursor = $collection->aggregate([
    ['$project' => ['UNIXtimestamp' => 1, $tag_values[0] => 1,$tag_values[1] => 1,$tag_values[2] => 1,$tag_values[3] => 1]], 
    ...
    'u1'=>'$'.$tag_values[0],'u2'=>'$'.$tag_values[1],'u3'=>'$'.$tag_values[2],'u4'=>'$'.$tag_values[3],
     ]],
