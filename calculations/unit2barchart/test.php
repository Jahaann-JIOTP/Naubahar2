...
function fetchData($start_date, $end_date)
{
  ...
  if (!empty($arr1)) {
    ...
    $array1[] = array(
      ...
      'Water Treatment' => (int)$count1);
       $array1[] = array(
      'Area' => 'Turbine 1',
      'Turbine 1' => (int)$count2 );
       $array1[] = array(
      'Area' => 'Syrup Room',
      'Syrup Room' => (int)$count3 );
       $array1[] = array(
      'Area' => 'Air Compressor(3+4+5)',
      'Air Compressor(3+4+5)' => (int)$count4 );
       $array1[] = array(
      'Area' => 'Air Compressor(1+2)',
      'Air Compressor(1+2)' => (int)$count5 );
       $array1[] = array(
      'Area' => 'Grasso 4',
      'Grasso 4' => (int)$count6 );
       $array1[] = array(
