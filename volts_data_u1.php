...
$Current_CN_Amp = round($msg[$meter.'_Current_CN_Amp'],2);
$Current_BN_Amp = 0;
if(isset( $msg[$meter.'_Current_BN_Amp']))
$Current_BN_Amp = round($msg[$meter.'_Current_BN_Amp'],2);
$Current_AN_Amp = 0;
if(isset( $msg[$meter.'_Current_AN_Amp']))
$Current_AN_Amp = round($msg[$meter.'_Current_AN_Amp'],2);
$Current_Avg_Amp = 0;
...
<div class="text" style="left: 251pt !important;top: 59pt;">
  <div>
    <p class="font-features"><?php echo $Current_CN_Amp; ?><b style="padding-left: 5px;">A</b><b style="padding-left: 5px;">c</b></p>
  </div>
</div>
<div class="text" style="left: 249pt !important;top: 143pt;">
  <div>
    <p class="font-features"><?php echo $Current_BN_Amp; ?><b style="padding-left: 5px;">A</b><b style="padding-left: 5px;">b</b></p>
  </div>
</div>
<div class="text" style="left: 247pt !important;top: 219pt;">
  <div>
   <p class="font-features"><?php echo $Current_AN_Amp; ?><b style="padding-left: 5px;">A</b><b style="padding-left: 5px;">a</b></p>
  </div>
</div>
